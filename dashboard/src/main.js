...
import { acknowledgeAlert, archiveAlert, approveAgent, bulkAcknowledgeAlerts, bulkArchiveAlerts, changeUserPassword, createGroup, createMaintenanceWindow, createSilence, createUser, deleteAgent, deleteMaintenanceWindow, deleteSilence, deleteUser, disableUser, enableUser, fetchAgentHistory, fetchAlerts, fetchMetricHistory, fetchSession, fetchSettings, fetchUptimeReport, loadDashboardData, login, logout, rejectAgent, requestAgentStatus, restartAgentCollectors, resumeAgent, setAgentCollectorConfig, setAgentDescription, sendReport, setAgentGroups, setMaintenance, updateSettings, } from './api';
